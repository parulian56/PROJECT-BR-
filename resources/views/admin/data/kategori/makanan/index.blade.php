...
<div class="bg-stone-100 min-h-screen py-8 px-4 sm:px-6">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row justify-between gap-4 mb-6">
            <form action="{{ route('admin.data.kategori.makanan.index') }}" method="GET" class="w-full md:w-1/2">
            ...
            <a
                href="{{ route('admin.data.kategori.makanan.create') }}"
                            ...
                            <tr class="hover:bg-amber-50 transition-colors duration-150">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-center">
                                    <div class="flex justify-center space-x-2">
                                        <a href="{{ route('admin.data.kategori.makanan.edit', $item->id) }}"
                                        ...
                                        <form action="{{ route('admin.data.kategori.makanan.destroy', $item->id) }}"
                                              method="POST"
                                              class="inline-block"
