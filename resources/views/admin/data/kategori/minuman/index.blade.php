...
<div class="container mx-auto p-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.data.kategori.minuman.create') }}" class="btn btn-primary px-6 py-2 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 transition">Tambah Data</a>
    </div>
                ...
                @foreach ($minuman as $item)
                    <tr class="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td class="py-3 px-4 text-sm">
                            <a href="{{ route('admin.data.kategori.minuman.edit', $item->id) }}" class="text-blue-600 hover:underline mr-2">Edit</a>
                            <form action="{{ route('admin.data.kategori.minuman.destroy', $item->id) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
