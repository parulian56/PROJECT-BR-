...
<div class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
            ...
            <a href="{{ route('admin.data.kategori.seragam.index') }}"
        ...
        <div class="bg-white rounded-xl shadow-xl overflow-hidden">
            ...
            <!-- Form Section -->
            <form action="{{ route('admin.data.kategori.seragam.update', $seragam->id) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama_barang" id="nama_barang"
                                ...
                                placeholder="Masukkan nama barang" value="{{ old('nama_barang', $seragam->nama_barang) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="kategori" id="kategori"
                                class="block w-full pl-10 pr-3 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-transparent shadow-sm transition duration-150 ease-in-out"
                                placeholder="Masukkan kategori" value="{{ old('kategori', $seragam->kategori) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="jumlah" id="jumlah" min="0"
                                class="block w-full pl-10 pr-3 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-transparent shadow-sm transition duration-150 ease-in-out"
                                placeholder="Masukkan jumlah barang" value="{{ old('jumlah', $seragam->jumlah) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="lokasi_penyimpanan" id="lokasi_penyimpanan"
                                class="block w-full pl-10 pr-3 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-transparent shadow-sm transition duration-150 ease-in-out"
                                placeholder="Masukkan lokasi penyimpanan" value="{{ old('lokasi_penyimpanan', $seragam->lokasi_penyimpanan) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" name="harga_pokok" id="harga_pokok" min="0"
                                ...
                                placeholder="0.00" value="{{ old('harga_pokok', $seragam->harga_pokok) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" name="harga_jual" id="harga_jual" min="0"
                                class="block w-full pl-16 pr-3 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-orange-500 focus:border-transparent shadow-sm transition duration-150 ease-in-out"
                                placeholder="0.00" value="{{ old('harga_satuan', $seragam->harga_jual) }}" required>
                        </div>
                        <div class="mt-1">
        ...
        <div class="mt-4 text-right text-sm text-gray-500">
            <p>Terakhir diperbarui: {{ $makseragamanan->updated_at->format('d M Y, H:i') }}</p>
        </div>
    </div>
</div>
