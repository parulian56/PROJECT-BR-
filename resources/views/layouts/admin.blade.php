    ...
    <main class="flex-1 p-4 md:p-6">
        ...
        <header class="flex justify-between items-center bg-white p-4 shadow rounded-lg">
            ...
            <div class="flex items-center space-x-4">
                <i class="fas fa-bell text-gray-600 hover:text-stone-500 cursor-pointer"></i>
                <i class="fas fa-bars text-gray-600 hover:text-stone-500 cursor-pointer"></i>
                <div class="bg-stone-500 w-10 h-10 rounded-full"></div>
            </div>
        </header>
