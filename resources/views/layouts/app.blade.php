                ...
                <div class="row">
                    <div class="col-md-3 mb-4">
                        <div class="dash-card p-4">
                            ...
                            <div class="dash-card-value">152</div>
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="dash-card p-4">
                            ...
                            <div class="dash-card-value">Rp 5.4 Jt</div>
                            <div class="text-success mt-2">
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="dash-card p-4">
                            ...
                            <div class="dash-card-value">87</div>
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="dash-card p-4">
                            ...
                            <div class="dash-card-value">42</div>
                            <div class="text-success mt-2">
                        ...
                        <div class="dash-card p-4">
                            ...
                            <div class="mb-3 pb-3 border-bottom">
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <span class="text-primary fw-bold">142 unit</span>
                                </div>
                            ...
                            <div class="mb-3 pb-3 border-bottom">
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <span class="text-primary fw-bold">98 unit</span>
                                </div>
                                <div class="progress" style="height: 8px">
                            ...
                            <div class="mb-3 pb-3 border-bottom">
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <span class="text-primary fw-bold">76 unit</span>
                                </div>
                                <div class="progress" style="height: 8px">
                            ...
                            <div class="mb-3">
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <span class="text-primary fw-bold">68 unit</span>
                                </div>
                                <div class="progress" style="height: 8px">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 text-md-end">
                        <p class="mb-0">&copy; 2025 Kasir Am. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </footer>
